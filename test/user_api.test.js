...
describe('user creation', () => {
  ...
  test('creation fails, username too short', async () => {
    ...
    expect(result.body.error).toContain('`username` (`do`) is shorter than the minimum allowed length')
  ...
  test('creation fails, password too short', async () => {
    ...
    expect(result.body.error).toContain('length of password is too short')
